...
`;
  ...
  frida_java_bridge_default.perform(function() {
    ...
    var inst = frida_java_bridge_default.cast(f.get(null), PC);
    function t(label, fn) {
      var t0 = Date.now();
      try {
    ...
    t("ch,salt,144000", function() {
      return inst.nativeCalculateDeepSeekHashV1Pow("20013b972357afc7698e07a7b51a632d1d5b265b5f6dd561a842e67cf69c4351", "42fe2d477b3c9a9e63b8", 144e3);
    });
    t("ch,salt,1000", function() {
      return inst.nativeCalculateDeepSeekHashV1Pow("20013b972357afc7698e07a7b51a632d1d5b265b5f6dd561a842e67cf69c4351", "42fe2d477b3c9a9e63b8", 1e3);
    });
    t("ch,salt,10000", function() {
      return inst.nativeCalculateDeepSeekHashV1Pow("20013b972357afc7698e07a7b51a632d1d5b265b5f6dd561a842e67cf69c4351", "42fe2d477b3c9a9e63b8", 1e4);
    });
  });
})();
